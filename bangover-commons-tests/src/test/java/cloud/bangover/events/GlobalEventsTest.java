...
public class GlobalEventsTest {
  ...
  @Test
  public void shouldGlobalEventListenerReactOnEveryEvent() {
    // Given
    ...
    // Then
    Assert.assertTrue(listener.getHistory().hasEntry(0,
        new EventDescriptor<>(BOUNDED_CONTEXT, EVENT_TYPE, ECHO_OBJECT)));
  }
